...
mutate src/color-assigner.ts 's/if \(oneDeficit === twoDeficit\) return null;//'                                                                             '5.2.2b equal deficits fall through'
mutate src/color-assigner.ts 's/\? -player\.colorDifference/? player.colorDifference/'                                                                       '5.2.2b deficit is oriented by the wanted colour'
