...
mutate src/color-state.ts    's/if \(lastTwoColorsAreSame\) diff = ColorPreference\.ABSOLUTE;//'                                                              '1.7.1  two-in-a-row is absolute'
mutate src/color-state.ts    's/\? getOppositeColor\(lastPlayedColor\)/? lastPlayedColor/'                                                                        '1.7.3  mild alternates from last game'
